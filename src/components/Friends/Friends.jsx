  ...
  return (
    <div>
      <Paginator
        ...
        pageSize={pageSize}
      />
      {props.usersData.map((usersData) => (
        <div key={usersData.id}>
          <div className={u.info}>
            <div className={u.inner}>
              <div className={u.review}>
                <NavLink to={"/profile/" + usersData.id}>
                  <img
                    src={
                      usersData.photos.small != null
                ...
                <div className={u.text}>
                  ...
                  <p>
                    {usersData.status != null
                      ? usersData.status
                      : "Hello! I am a new user of this social network."}
                  </p>
                </div>
                {usersData.followed ? (
                  <button
